...
export const defaultKubernetesFetchOptions: KubernetesFetchOptions = {
    selectors: [
        ...
        // { action: "exclude", kinds: [{ apiVersion: "v1", kind: "Secret" }], type: "kubernetes.io/service-account-token" },
        { action: "exclude", kinds: [{ apiVersion: "v1", kind: "Secret" }], name: /-token-[a-z0-9]{5}$/ },
